...
(function () {
  ...
  var TRANSLATIONS = {
    ...
    fr: {
      tqCard: "Carte du cadre des certifications (CNC/TVQF)",
      tqExtCard: "Champs etendus (facultatif)",
      tqClear: "Vider la carte",
      tqClearConfirm: "⚠️ Vider la carte du cadre ?\n\nTous les champs des deux parties seront effaces, dans les deux langues.\nCette action est irreversible.\n\nContinuer ?",
      tqCleared: "Carte du cadre videe",
      tqBasicNote: "Facultatif. Indique la place de ce module dans un cadre national de certification. Les champs laisses vides ne sont pas exportes.",
      tqExtNote: "Seuls les champs remplis apparaissent dans le document exporte.",
      tqFromUnitTable: "Depuis le tableau d'informations du module",
      tqFramework: "Nom du cadre et version / annee",
      tqFrameworkHint: "ex. TVQF - Irak, lignes directrices 2018",
      tqHours: "Heures d'apprentissage notionnelles",
      tqAwardingBody: "Organisme certificateur",
      tqKnowledge: "Savoirs",
      tqSkill: "Aptitudes",
      tqCompetence: "Competences",
      tqEntry: "Conditions d'acces / prerequis",
      ...
      tqMethod: "Methode d'evaluation",
      tqRpl: "Validation des acquis (RPL)",
      tqYes: "Oui",
      tqNo: "Non",
      tqAccredited: "Date d'accreditation",
      tqReviewDue: "Date de revision prevue",
      tqAlignment: "Referencement international / regional",
      tqAlignmentHint: "ex. referencee au niveau 4 du CEC",
      cvSector: "Secteur :",
      cvOccupation: "Metier :",
      cvJob: "Poste :",
      cvQualification: "Intitule de la certification :",
      cvUnitTitle: "Intitule de l'unite :",
      cvModuleCode: "Code de l'unite :",
      cvLevel: "Niveau :",
      cvVersion: "Version :",
      cvEntryReq: "Conditions d'acces / prerequis :",
      cvQualType: "Type de certification :",
      cvFramework: "Nom du cadre et version / annee :",
      cvFrameworkHint: "ex. TVQF - Irak, lignes directrices 2018",
      cvHours: "Heures d'apprentissage notionnelles :",
      cvAwardingBody: "Organisme certificateur :",
      cvRpl: "Validation des acquis (RPL) :",
      cvAccredited: "Date d'accreditation :",
      cvReviewDue: "Date de revision prevue :",
      cvAlignment: "Referencement international / regional :",
      cvAlignmentHint: "ex. referencee au niveau 4 du CEC",
      tqCardHeading: "Cadre des certifications",
      tqExtHeading: "Cadre des certifications - details complementaires",
    },
