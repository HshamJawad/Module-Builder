...
(function () {
  ...
  var TRANSLATIONS = {
    ...
    en: {
      ...
      rxPasteImage: "Paste Image",
      rxPasteImageTip: "Paste an image copied from the clipboard or a web page",
      dgPasteHint: "Press Ctrl+V now (⌘+V on Mac) to paste the copied image.",
      dgPasteNoImage: "No image found on the clipboard.",
      dgImagePasted: "Image pasted",
      dgPasteUrlFailed: "That is an image link, not an image. Use right-click → Copy image.",
      rxRename: "Rename",
    ...
    fr: {
      ...
      rxPasteImage: "Coller une image",
      rxPasteImageTip: "Coller une image copiée depuis le presse-papiers ou une page web",
      dgPasteHint: "Appuyez sur Ctrl+V (⌘+V sur Mac) pour coller l'image copiée.",
      dgPasteNoImage: "Aucune image dans le presse-papiers.",
      dgImagePasted: "Image collée",
      dgPasteUrlFailed: "Il s'agit d'un lien d'image, pas d'une image. Utilisez : clic droit → Copier l'image.",
      rxRename: "Renommer",
    ...
    ar: {
      ...
      rxPasteImage: "لصق صورة",
      rxPasteImageTip: "لصق صورة منسوخة من الحافظة أو من صفحة ويب",
      dgPasteHint: "اضغط Ctrl+V الآن (أو ⌘+V على ماك) للصق الصورة المنسوخة.",
      dgPasteNoImage: "لا توجد صورة في الحافظة.",
      dgImagePasted: "تم لصق الصورة",
      dgPasteUrlFailed: "ما نُسخ هو رابط صورة وليس صورة. استخدم: زر يمين ← نسخ الصورة.",
