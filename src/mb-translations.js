...
(function () {
  ...
  var TRANSLATIONS = {
    ...
    en: {
      ...
      tqCard: "Qualifications Framework Card (TVQF/NQF)",
      tqExtCard: "Extended Fields (Optional)",
      tqClear: "Clear framework card",
      tqClearConfirm: "⚠️ Clear the framework card?\n\nThis empties every field in both halves of the card, in both languages.\nThis action cannot be undone.\n\nContinue?",
      tqCleared: "Framework card cleared",
      tqBasicNote: "Optional. Describes where this module sits in a national qualifications framework. Fields left empty are not exported.",
      tqExtNote: "Only the fields you fill in appear in the exported document.",
      tqFromUnitTable: "From the module information table",
      tqFramework: "Framework Name & Version / Year",
      tqFrameworkHint: "e.g. TVQF - Iraq, 2018 Guidelines",
      tqHours: "Notional Learning Hours",
      tqAwardingBody: "Awarding / Accrediting Body",
      tqKnowledge: "Knowledge",
      tqSkill: "Skill",
      tqCompetence: "Competence",
      tqEntry: "Entry Requirements / Prerequisites",
      tqProgression: "Progression Pathway",
      tqType: "Qualification Type",
      tqTypePrincipal: "Principal",
      tqTypeComponent: "Component",
      tqTypeAddendum: "Addendum",
      tqMethod: "Assessment Method",
      tqRpl: "Recognition of Prior Learning (RPL)",
      tqYes: "Yes",
      tqNo: "No",
      tqAccredited: "Accreditation Date",
      tqReviewDue: "Review Due Date",
      tqAlignment: "International / Regional Referencing",
      tqAlignmentHint: "e.g. referenced to EQF level 4",
      tqCardHeading: "Qualifications Framework",
      tqExtHeading: "Qualifications Framework - Additional Details",
      mbCovers: "Covers",
      ...
      mbTaskAnalysisReference: "📥 Task Analysis Reference (from DACUM Live Pro)",
      mbTaskAnalysisReferenceIntro: "Source detail for this module's task(s) — for your reference only. Nothing here is copied automatically; use it while writing the Information Sheet, Activity/Job Sheet and Assessment Unit below.",
      mbTaReqKnowledge: "📘 Required Knowledge",
      mbTaReqSkills: "🧩 Required Skills",
      mbTaPerfSteps: "🛠️ Performance Steps",
      mbTaTools: "🧰 Tools, Equipment & Materials",
      mbTaSafety: "⚠️ Safety / OSH",
      mbTaConditions: "🏗️ Conditions / Work Environment",
      mbTaDecisions: "🧭 Decisions / Critical Points",
      mbTaStandard: "🎯 Performance Standard",
      mbTaErrors: "🐛 Common Errors / Troubleshooting",
      mbTrainingStructureMapping: "Training Structure Mapping",
      mbMappingIntro: "Propose Information Sheets, Activity/Job Sheets, and Assessment content from this module's Learning Outcomes, Performance Criteria and Task Analysis — then review, edit, and approve before anything is built. Nothing is written automatically.",
      mbAiAssistedMapping: "🤖 AI-Assisted Mapping",
      mbManualMapping: "✍️ Manual Mapping",
      mbAiModeExplain: "The AI analyzes only this module's own data (Learning Outcomes, Performance Criteria, source Tasks, and whatever Task Analysis fields were actually filled in) and proposes a structure. It never invents missing occupational facts.",
      mbAnalyzeAndSuggest: "Analyze & Suggest Structure",
      mbNoModuleSelected: "Please select a module first.",
      mbNoLOsToAnalyze: "This module has no Learning Outcomes to analyze yet.",
      mbAnalyzing: "Analyzing…",
      mbAiRateLimited: "The AI service is busy right now — please try again in a moment.",
      mbAiServerError: "The AI service is temporarily unavailable. Please try again shortly.",
      mbAiRequestFailed: "The request could not be completed. Please try again.",
      mbAiInvalidResponse: "The AI returned an unexpected response. Please try again.",
      mbAiProposalReady: "Proposed structure ready for your review.",
      mbAiTimeout: "The request took too long and was cancelled. Please try again.",
      mbAiNetworkError: "Could not reach the AI service — check your connection and try again.",
      mbSources: "Sources",
      mbNoItemsYet: "Nothing here yet.",
      mbProposalInfoSheets: "INFORMATION SHEETS",
      mbAddInfoSheetSuggestion: "Add Information Sheet",
      mbActivityJobSheets: "ACTIVITY / JOB SHEETS",
      mbAddActivitySheetSuggestion: "Add Activity / Job Sheet",
      mbAssessmentUnitsTitle: "ASSESSMENT",
      mbAddAssessmentSuggestion: "Add Assessment Suggestion",
      mbMissingInfoTitle: "Missing information",
      mbApproveAndBuild: "Approve & Build Module",
      mbEnterTitle: "Enter title:",
      mbNothingToApprove: "There is nothing to approve yet.",
      mbConfirmApprove: "Build {v0} item(s) into real sheets now? You can keep editing them afterward.",
      mbModuleBuilt: "The approved items have been added to this module.",
      mbNotLinkedYet: "Not linked to any source yet — click the edit icon to connect it.",
      mbEditLinks: "Edit title & links",
      mbLinkLearningOutcomes: "Link to Learning Outcome(s)",
      mbLinkPerformanceCriteria: "Link to Performance Criteria",
      mbLinkSourceTasks: "Link to source Task(s)",
      mbLinkTaFields: "Link to Task Analysis field(s)",
      mbLinkTaItems: "Select individual Task Analysis item(s)",
      mbSourceBrowserTitle: "Browse Task Analysis — select items, then create a sheet",
      mbSourceBrowserIntro: "Check individual items below, then choose which kind of sheet to create from them. Nothing is created until you press one of the buttons.",
      mbCreateInfoFromSelection: "Create Information Sheet",
      mbCreateActivityFromSelection: "Create Activity / Job Sheet",
      mbCreateAssessmentFromSelection: "Create Assessment",
      mbSelectAtLeastOneItem: "Select at least one item first.",
      mbItemCreatedFromSelection: "Added to the proposal below — edit its title or links any time.",
      mbSomeAssessmentsSkipped: "{v0} assessment suggestion(s) were skipped — link a Learning Outcome to them first (edit icon), then approve again.",
      mbAllItemsAssigned: "All Task Analysis items for this module are already assigned — unassign one below to make it available again.",
      mbNoneYet: "none yet",
      mbInheritedLinksTitle: "Inherited from Task Analysis (automatic — not editable here)",
      mbAssignedItemsTitle: "Assigned / Used Items",
      mbAssignedItemsIntro: "Where each selected item currently belongs. Move it to a different sheet, or unassign it to return it to the browser above.",
      mbMoveTo: "Move to…",
      mbUnassign: "Unassign — return to Available",
      mbItemMovedTo: "Moved to \"{v0}\".",
      ...
      mbRemoveFrontCoverImage: "Remove Front Cover Image",
      ...
      mbFillInTheModuleDetailsBelow: "Fill in the module details below. Field labels can be edited directly — click a label and type. Empty fields are not exported.",
      cvLabelEditHint: "Click to edit this label",
      mbInfoObjectiveLead: "After studying this information sheet, you will be able to:",
      mbActivityObjectiveLead: "After completing this activity, you will be able to:",
      ...
      mbRemoveBackCoverImage: "Remove Back Cover Image",
      ...
      cvJob: "Job:",
      cvQualification: "Qualification Title:",
      cvUnitTitle: "Unit Title:",
      cvModuleCode: "Unit Code:",
      cvLevel: "Level:",
      cvVersion: "Version:",
      cvEntryReq: "Entry Requirements / Prerequisites:",
      cvQualType: "Qualification Type:",
      cvFramework: "Framework Name & Version / Year:",
      cvFrameworkHint: "e.g. TVQF - Iraq, 2018 Guidelines",
      cvHours: "Notional Learning Hours:",
      cvAwardingBody: "Awarding / Accrediting Body:",
      cvRpl: "Recognition of Prior Learning (RPL):",
      cvAccredited: "Accreditation Date:",
      cvReviewDue: "Review Due Date:",
      cvAlignment: "International / Regional Referencing:",
      cvAlignmentHint: "e.g. referenced to EQF level 4",
      ...
      dgRenameContent: "Rename this content section",
      mbNoContentSections: "No content sections yet. Use the button below to add one.",
      mbNoSteps: "No steps yet. Use the button below to add one.",
      dgEnterContentHeading: "Name for this content section (leave empty to restore the default):",
      dgContentRenamed: "Content section renamed!",
      dgContentHeadingReset: "Default name restored.",
      ...
      /* ── Learning Guide ─────────────────────────────────────────
         The three instruction blocks are the TOOL's words, not the
         author's, which is why they live here and are emitted in the
         export language rather than the interface one. */
    ...
    fr: {
      mbModuleBuilderV20: "Module Builder V 2.0",
      mbACompetencyBasedTrainingModuleDevelopm: "Un outil de développement de modules de formation par compétences, pour structurer les résultats d'apprentissage, les activités et les évaluations.",
      mbBasicInfo: "🏠 Informations de base",
      tqCard: "Fiche du cadre de certification (TVQF/NQF)",
      tqExtCard: "Champs étendus (facultatif)",
      tqClear: "Vider la fiche du cadre",
      tqClearConfirm: "⚠️ Vider la fiche du cadre ?\n\nCela efface tous les champs des deux parties de la fiche, dans les deux langues.\nCette action est irréversible.\n\nContinuer ?",
      tqCleared: "Fiche du cadre vidée",
      tqBasicNote: "Facultatif. Indique la place de ce module dans un cadre national de certification. Les champs laissés vides ne sont pas exportés.",
      tqExtNote: "Seuls les champs que vous remplissez apparaissent dans le document exporté.",
      tqFromUnitTable: "Depuis le tableau d'informations du module",
      tqFramework: "Nom du cadre et version / année",
      tqFrameworkHint: "ex. TVQF – Irak, lignes directrices 2018",
      tqHours: "Heures d'apprentissage notionnelles",
      tqAwardingBody: "Organisme certificateur / d'accréditation",
      tqKnowledge: "Savoirs",
      tqSkill: "Aptitudes",
      tqCompetence: "Compétences",
      tqEntry: "Conditions d'accès / prérequis",
      tqProgression: "Parcours de progression",
      tqType: "Type de certification",
      tqTypePrincipal: "Principale",
      tqTypeComponent: "Composante",
      tqTypeAddendum: "Additif",
      tqMethod: "Méthode d'évaluation",
      tqRpl: "Validation des acquis de l'expérience (VAE)",
      tqYes: "Oui",
      tqNo: "Non",
      tqAccredited: "Date d'accréditation",
      tqReviewDue: "Date de révision prévue",
      tqAlignment: "Référencement international / régional",
      tqAlignmentHint: "ex. référencée au niveau 4 du CEC",
      tqCardHeading: "Cadre de certification",
      tqExtHeading: "Cadre de certification – informations complémentaires",
      mbCovers: "Couvertures",
      mbIntroductionPages: "Pages d'introduction",
      mbInformationSheet: "Fiche d'information",
      mbActivityJobSheet: "Fiche d'activité / de travail",
      mbAssessmentUnit: "Unité d'évaluation",
      mbReferences: "📚 Références",
      mbHelp: "❓ Aide",
      mbClearImportedStructureStartManualAutho: "🧹 Effacer la structure importée et rédiger manuellement",
      mbModuleManagement: "📦 Gestion des modules",
      mbAddModule: "➕ Ajouter un module",
      mbCurrentModule: "Module en cours :",
      mbSelectModule: "-- Choisir un module --",
      mbRename: "Renommer",
      mbDelete: "Supprimer",
      mbUntitled: "Sans titre",
      mbLearningOutcomes: "📚 Résultats d'apprentissage :",
      mbTotalSheets: "📄 Total des fiches :",
      mbTaskAnalysisReference: "📥 Référence Analyse des tâches (depuis DACUM Live Pro)",
      mbTaskAnalysisReferenceIntro: "Détails source pour la ou les tâches de ce module — à titre de référence uniquement. Rien n'est copié automatiquement ; utilisez ces informations en rédigeant la Fiche d'information, la Fiche d'activité/de travail et l'Unité d'évaluation ci-dessous.",
      mbTaReqKnowledge: "📘 Connaissances requises",
      mbTaReqSkills: "🧩 Compétences requises",
      mbTaPerfSteps: "🛠️ Étapes de réalisation",
      mbTaTools: "🧰 Outils, équipements et matériaux",
      mbTaSafety: "⚠️ Sécurité / SST",
      mbTaConditions: "🏗️ Conditions / Environnement de travail",
      mbTaDecisions: "🧭 Décisions / Points critiques",
      mbTaStandard: "🎯 Norme de performance",
      mbTaErrors: "🐛 Erreurs courantes / Dépannage",
      mbTrainingStructureMapping: "Structuration pédagogique",
      mbMappingIntro: "Proposez des fiches d'information, des fiches d'activité/de travail et un contenu d'évaluation à partir des résultats d'apprentissage, des critères de performance et de l'analyse des tâches de ce module — puis relisez, modifiez et approuvez avant toute création. Rien n'est écrit automatiquement.",
      mbAiAssistedMapping: "🤖 Structuration assistée par IA",
      mbManualMapping: "✍️ Structuration manuelle",
      mbAiModeExplain: "L'IA analyse uniquement les données propres à ce module (résultats d'apprentissage, critères de performance, tâches sources, et les champs d'analyse des tâches réellement renseignés) et propose une structure. Elle n'invente jamais de faits professionnels manquants.",
      mbAnalyzeAndSuggest: "Analyser et proposer une structure",
      mbNoModuleSelected: "Veuillez d'abord sélectionner un module.",
      mbNoLOsToAnalyze: "Ce module n'a pas encore de résultats d'apprentissage à analyser.",
      mbAnalyzing: "Analyse en cours…",
      mbAiRateLimited: "Le service IA est occupé — veuillez réessayer dans un instant.",
      mbAiServerError: "Le service IA est temporairement indisponible. Veuillez réessayer sous peu.",
      mbAiRequestFailed: "La demande n'a pas pu aboutir. Veuillez réessayer.",
      mbAiInvalidResponse: "L'IA a renvoyé une réponse inattendue. Veuillez réessayer.",
      mbAiProposalReady: "Structure proposée prête à être examinée.",
      mbAiTimeout: "La demande a pris trop de temps et a été annulée. Veuillez réessayer.",
      mbAiNetworkError: "Impossible de joindre le service IA — vérifiez votre connexion et réessayez.",
      mbSources: "Sources",
      mbNoItemsYet: "Rien pour l'instant.",
      mbProposalInfoSheets: "FICHES D'INFORMATION",
      mbAddInfoSheetSuggestion: "Ajouter une fiche d'information",
      mbActivityJobSheets: "FICHES D'ACTIVITÉ / DE TRAVAIL",
      mbAddActivitySheetSuggestion: "Ajouter une fiche d'activité/de travail",
      mbAssessmentUnitsTitle: "ÉVALUATION",
      mbAddAssessmentSuggestion: "Ajouter une suggestion d'évaluation",
      mbMissingInfoTitle: "Informations manquantes",
      mbApproveAndBuild: "Approuver et créer le module",
      mbEnterTitle: "Saisir le titre :",
      mbNothingToApprove: "Il n'y a encore rien à approuver.",
      mbConfirmApprove: "Créer {v0} élément(s) sous forme de fiches réelles maintenant ? Vous pourrez continuer à les modifier ensuite.",
      mbModuleBuilt: "Les éléments approuvés ont été ajoutés à ce module.",
      mbNotLinkedYet: "Pas encore relié à une source — cliquez sur l'icône de modification pour le connecter.",
      mbEditLinks: "Modifier le titre et les liens",
      mbLinkLearningOutcomes: "Relier à un ou plusieurs résultats d'apprentissage",
      mbLinkPerformanceCriteria: "Relier à des critères de performance",
      mbLinkSourceTasks: "Relier à une ou plusieurs tâches sources",
      mbLinkTaFields: "Relier à des champs d'analyse des tâches",
      mbLinkTaItems: "Sélectionner des éléments individuels de l'analyse des tâches",
      mbSourceBrowserTitle: "Parcourir l'analyse des tâches — sélectionner des éléments, puis créer une fiche",
      mbSourceBrowserIntro: "Cochez des éléments individuels ci-dessous, puis choisissez le type de fiche à créer à partir d'eux. Rien n'est créé avant d'appuyer sur l'un des boutons.",
      mbCreateInfoFromSelection: "Créer une fiche d'information",
      mbCreateActivityFromSelection: "Créer une fiche d'activité/de travail",
      mbCreateAssessmentFromSelection: "Créer une évaluation",
      mbSelectAtLeastOneItem: "Sélectionnez au moins un élément.",
      mbItemCreatedFromSelection: "Ajouté à la proposition ci-dessous — modifiez son titre ou ses liens à tout moment.",
      mbSomeAssessmentsSkipped: "{v0} suggestion(s) d'évaluation ont été ignorées — reliez-leur d'abord un résultat d'apprentissage (icône de modification), puis approuvez à nouveau.",
      mbAllItemsAssigned: "Tous les éléments de l'analyse des tâches de ce module sont déjà attribués — désattribuez-en un ci-dessous pour le rendre à nouveau disponible.",
      mbNoneYet: "aucun pour l'instant",
      mbInheritedLinksTitle: "Hérité de l'analyse des tâches (automatique — non modifiable ici)",
      mbAssignedItemsTitle: "Éléments attribués / utilisés",
      mbAssignedItemsIntro: "Où se trouve actuellement chaque élément sélectionné. Déplacez-le vers une autre fiche, ou désattribuez-le pour le renvoyer au panneau ci-dessus.",
      mbMoveTo: "Déplacer vers…",
      mbUnassign: "Désattribuer — renvoyer vers Disponible",
      mbItemMovedTo: "Déplacé vers « {v0} ».",
      mbLearningOutcomeManagement: "📚 Gestion des résultats d'apprentissage",
      mbAddLearningOutcome: "➕ Ajouter un résultat d'apprentissage",
      mbCurrentLearningOutcome: "Résultat d'apprentissage en cours :",
      mbSelectLearningOutcome: "-- Choisir un résultat d'apprentissage --",
      mbModule: "📦 Module :",
      mbInformationSheets: "📄 Fiches d'information :",
      mbActivitySheets: "⚡ Fiches d'activité :",
      mbAddCriterion: "➕ Ajouter un critère",
      mbNoPerformanceCriteriaAvailable: "Aucun critère de performance disponible",
      mbFrontCover: "🖼️ Couverture avant",
      mbOptionalExportedAsTheVeryFirst: "(Facultatif — exportée en toute première page)",
      mbTip: "Conseil :",
      mbA4SizedImage210297Mm: "image au format A4 (210 × 297 mm)",
      mb24803508Px: "2480 × 3508 px",
      mb12401754Px: "1240 × 1754 px",
      mbClickOrDragDropToUpload: "Cliquez ou glissez-déposez pour téléverser l'image de couverture avant",
      mbPngJpgWebpWillBeStretched: "PNG, JPG, WEBP — sera étirée pour remplir toute la page A4 (210 × 297 mm)",
      mbImageLoadedWillBeTheFirst: "✓ Image chargée — elle sera la première page à l'export. Cliquez pour la remplacer.",
      mbRemoveFrontCoverImage: "Retirer l'image de couverture avant",
      mbCoverPageInformation: "📋 Informations de la page de couverture",
      mbAdditionalInformationOptional: "Informations complémentaires (facultatif)",
      mbProjectNameInstitutionEtc: "Nom du projet, établissement, etc.",
      mbEnterAnyAdditionalInformationEG: "Saisissez toute information complémentaire (nom du projet, nom de l'établissement, etc.)...",
      mbModuleInformationTable: "Tableau d'informations du module",
      mbAddCustomRow: "➕ Ajouter une ligne personnalisée",
      mbFillInTheModuleDetailsBelow: "Renseignez les détails du module ci-dessous. Les intitulés des champs se modifient directement : cliquez sur un intitulé et saisissez. Les champs laissés vides ne sont pas exportés.",
      cvLabelEditHint: "Cliquez pour modifier cet intitulé",
      mbInfoObjectiveLead: "Après avoir étudié cette fiche d'information, vous serez capable de :",
      mbActivityObjectiveLead: "Après avoir réalisé cette activité, vous serez capable de :",
      mbTableRowsWillBeAddedHere: "Les lignes du tableau seront ajoutées ici dynamiquement",
      mbAdditionalNotesOptional: "Notes complémentaires (facultatif)",
      mbExtraInformationAfterTheTable: "Informations supplémentaires après le tableau",
      mbEnterAnyAdditionalNotesToAppear: "Saisissez les notes à faire figurer après le tableau d'informations du module...",
      mbBackCover: "🖼️ Couverture arrière",
      mbOptionalExportedAsTheLastPage: "(Facultatif — exportée en dernière page)",
      mbClickOrDragDropToUpload2: "Cliquez ou glissez-déposez pour téléverser l'image de couverture arrière",
      mbImageLoadedWillFillFullA4: "✓ Image chargée — elle remplira toute la page A4 à l'export. Cliquez pour la remplacer.",
      mbRemoveBackCoverImage: "Retirer l'image de couverture arrière",
      mbProceedToIntroductionPages: "Passer aux pages d'introduction →",
      mbIntroductionPages2: "📄 Pages d'introduction",
      mbWorkTeam: "Équipe de travail",
      mbAddTeamMember: "➕ Ajouter un membre",
      mbAddTeamMembersWhoWorkedOn: "Ajoutez les membres de l'équipe ayant travaillé sur ce module. Ils apparaîtront sur une nouvelle page après la couverture.",
      mbTeamMembersWillBeAddedHere: "Les membres de l'équipe seront ajoutés ici dynamiquement",
      mbAdditionalIntroductionDetailsOptional: "Détails d'introduction complémentaires (facultatif)",
      mbStartsOnNewPageIfFilled: "Commence sur une nouvelle page si rempli",
      mbExtraIntroductionSections: "Sections d'introduction supplémentaires (facultatif)",
      mbEachSectionStartsOnNewPage: "Chaque section commence sur une nouvelle page — les sections vides ne sont pas exportées",
      mbAddIntroductionSection: "➕ Ajouter une section d'introduction",
      mbModuleContents: "Contenu du module",
      mbLearningOutcomeSections: "Sections du résultat d'apprentissage (facultatif)",
      mbEmptySectionsNotExported: "Les sections vides ne sont pas exportées",
      mbAddSection: "➕ Ajouter une section",
      mbSectionTitlePlaceholder: "Titre de la section — apparaît comme intertitre dans le fichier exporté",
      mbSectionBodyPlaceholder: "Laissez vide pour exclure cette section du fichier exporté…",
      mbRemoveSection: "Supprimer la section",
      dgImageOptimized: "Image optimisée : {v0} → {v1}",
      dgSectionAdded: "Section ajoutée",
      dgSectionDeleted: "Section supprimée",
      dgConfirmDeleteSection: "Supprimer cette section ?\n\nSon titre et son texte seront perdus. Continuer ?",
      mbEnterAnyAdditionalIntroductionContentA: "Saisissez tout contenu d'introduction complémentaire (remerciements, avant-propos, etc.). Il commencera sur une nouvelle page s'il est rempli...",
      mbProceedToInformationSheet: "Passer à la fiche d'information →",
      mbLearningOutcome: "📚 Résultat d'apprentissage :",
      mbRemoveSheet: "Supprimer la fiche",
      mbPreviousInfoSheet: "Fiche d'information précédente",
      mbSheet1Of1: "Fiche 1 sur 1",
      mbNextInfoSheet: "Fiche d'information suivante",
      mbAddInfoSheet: "➕ Ajouter une fiche d'information",
      mbInformationSheetTitle: "Titre de la fiche d'information :",
      mbEnterInformationSheetTitle: "Saisissez le titre de la fiche d'information...",
      mbObjective: "Objectif :",
      mbNumber: "🔢 Numéros",
      mbConvertToNumberedList: "Convertir en liste numérotée",
      mbBullet: "• Puces",
      mbConvertToBulletedList: "Convertir en liste à puces",
      mbClear: "✖ Effacer",
      mbClearFormatting: "Effacer la mise en forme",
      mbEnterTheLearningObjective: "Saisissez l'objectif d'apprentissage...",
      mbContent: "Contenu :",
      mbQrCodeLink: "QR code et lien :",
      mbVideoResourceSubject: "Sujet de la vidéo / ressource :",
      mbEGPaintlessDentRemovalTutorial: "ex. tutoriel de débosselage sans peinture",
      mbVideoResourceLink: "Lien de la vidéo / ressource :",
      mbQrCodeImage: "Image du QR code :",
      mbUploadQrCode25cmX: "🖼️ Téléverser un QR code (2,5 cm × 2,5 cm)",
      mbSelfCheck: "Auto-évaluation :",
      mbNumberedList: "Liste numérotée",
      mbBulletList: "Liste à puces",
      mbRemoveNumberingBullets: "Supprimer la numérotation / les puces",
      mbClearAllNumberContent: "Tout effacer (numéro + contenu)",
      mbEnterSelfCheckQuestionsAndContent: "Saisissez les questions et le contenu d'auto-évaluation...",
      mbAnswersKey: "Corrigé :",
      mbEnterAnswersKeyContent: "Saisissez le contenu du corrigé...",
      mbProceedToActivityJobSheet: "Passer à la fiche d'activité / de travail →",
      mbPreviousActivitySheet: "Fiche d'activité précédente",
      mbNextActivitySheet: "Fiche d'activité suivante",
      mbAddActivitySheet: "➕ Ajouter une fiche d'activité",
      mbActivitySheetTitle: "Titre de la fiche d'activité :",
      mbEnterActivitySheetTitle: "Saisissez le titre de la fiche d'activité...",
      mbEnterTheLearningObjectiveForThis: "Saisissez l'objectif d'apprentissage de cette activité...",
      mbDurationMinutes: "Durée (minutes) :",
      mbExample45Minutes: "Exemple : 45 minutes",
      mbTrainingResources: "Ressources de formation :",
      mbMaterialEquipment: "Matériel / équipement",
      mbQuantityNumber: "Quantité / nombre",
      mbAddRow: "➕ Ajouter une ligne",
      mbClearRows: "Vider les lignes",
      mbActivitySteps: "Étapes de l'activité :",
      mbPerformanceCriteriaCheckList: "Liste de vérification des critères de performance :",
      mbPerformanceCriteriaCheckList11: "Liste de vérification des critères de performance / 1-1",
      mbBeforeYouTellTheTrainerTo: "Avant de demander au formateur de clôturer l'activité... évaluez-vous en répondant aux questions suivantes :",
      mbDidYou: "Avez-vous...",
      mbThePerformanceLevelAnswerForAll: "La réponse attendue pour tous les items est (oui). Si la réponse est (non), la compétence doit être retravaillée jusqu'à sa maîtrise.",
      mbProceedToAssessmentUnit: "Passer à l'unité d'évaluation →",
      mbAssessmentUnit2: "📋 Unité d'évaluation",
      mbAssessmentContent: "Contenu de l'évaluation",
      mbInstructionsCriteriaGuidelines: "Consignes, critères, lignes directrices",
      mbEnterAssessmentContentInstructionsAndC: "Saisissez ici le contenu, les consignes et les critères de l'évaluation...",
      mbAssessmentFormsPerLearningOutcome: "Formulaires d'évaluation par résultat d'apprentissage",
      mbAddAssessmentForm: "➕ Ajouter un formulaire d'évaluation",
      mbRenameSectionHeading: "Renommer l'intertitre de la section",
      mbEGSmithJ2020Vocational: "ex. Smith, J. (2020). Manuel de la formation professionnelle. Éditeur.",
      mbAddReference: "➕ Ajouter une référence",
      mbHelpCenter: "Centre d'aide",
      mbEverythingYouNeedToUseModule: "Tout ce qu'il faut savoir pour utiliser Module Builder efficacement",
      mbQuickStartHowToUseModule: "Démarrage rapide : comment utiliser Module Builder",
      mbBasicInfo2: "Informations de base",
      mbActivityJobSheet2: "Fiche d'activité / de travail",
      mbReferences2: "Références",
      mbSaveWork: "💾 Enregistrer le travail",
      mbLoadWork: "Charger un travail",
      mbExportToWord: "📄 Exporter vers Word",
      mbUserGuide: "Guide de l'utilisateur",
      mbAccessTheFullDocumentationForModule: "Accédez à la documentation complète de Module Builder — instructions détaillées, captures d'écran et bonnes pratiques.",
      mbOpenUserGuide: "📖 Ouvrir le guide",
      mbDownloadPdf: "⬇️ Télécharger le PDF",
      mbScanToOpenTheUserGuide: "Scannez pour ouvrir le guide de l'utilisateur sur votre appareil mobile.",
      mbAboutTheCreator: "À propos du créateur",
      mbCreatorOfModuleBuilder: "Créateur de Module Builder",
      mbTvetCurriculumDeveloperEducationalTech: "Concepteur de curricula EFTP et innovateur en technologie éducative",
      mbEmail: "Courriel",
      mbLinkedin: "LinkedIn",
      mbGetInTouch: "Nous contacter",
      mbForQuestionsFeedbackSuggestionsOrColla: "Pour toute question, remarque, suggestion ou proposition de collaboration, veuillez utiliser les coordonnées ci-dessus.",
      mb2026ModuleBuilderByHushamJawad: "© 2026 Module Builder | par Husham Jawad Kadhim | Version 2.0 | Tous droits réservés",
      mbDisclaimer: "Avertissement :",
      dgLangLocked: "La langue ne peut pas être changée pendant qu'une opération est en cours.",
      dgNoLearningOutcomesAvailablePlease: "Aucun résultat d'apprentissage disponible. Veuillez d'abord en ajouter un.",
      dgAllLearningOutcomesAlreadyHave: "Tous les résultats d'apprentissage disposent déjà d'un formulaire d'évaluation.",
      dgNoAssessmentFormsYet: "Aucun formulaire d'évaluation créé pour l'instant. Cliquez sur « Ajouter un formulaire d'évaluation » pour en créer un.",
      dgClearImportedStartManual: "\u26a0\ufe0f Effacer la structure importée et rédiger manuellement ?\n\nCela va :\n\u2022 effacer tous les modules, résultats d'apprentissage et critères de performance importés\n\u2022 basculer en mode de rédaction manuelle\n\u2022 vous permettre de créer vos propres modules de zéro\n\nCette action est irréversible. Continuer ?",
      dgClearAllDataInThis: "Effacer toutes les données de ce formulaire d'évaluation (lignes, résultats, signatures) ?",
      dgDeleteThisAssessmentFormCompletely: "Supprimer complètement ce formulaire d'évaluation ? Le résultat d'apprentissage ne sera pas supprimé.",
      dgCannotDeleteTheLastRow: "Impossible de supprimer la dernière ligne. Utilisez plutôt « Vider les lignes ».",
      dgAreYouSureYouWant: "Voulez-vous vraiment vider toutes les lignes de ce résultat d'apprentissage ?",
      dgConfirmDeletionthisWillPermanently: "⚠️ Confirmer la suppression\n\nCette section de contenu et ses images seront définitivement supprimées.\nCette action est irréversible.\n\nContinuer ?",
      dgConfirmDeletionthisWillPermanently2: "⚠️ Confirmer la suppression\n\nTout le contenu de la fiche d'information sera définitivement effacé, y compris :\n• le titre et l'objectif de la fiche\n• toutes les sections de contenu et images\n• le QR code et les liens\n• l'auto-évaluation et le corrigé\n\nCette action est irréversible.\n\nContinuer ?",
      dgInformationSheetCleared: "Fiche d'information vidée !",
      dgEnterNewLabelName: "Saisissez le nouvel intitulé :",
      dgConfirmDeletionthisWillPermanently3: "⚠️ Confirmer la suppression\n\nCette ligne du tableau de couverture sera définitivement supprimée.\nCette action est irréversible.\n\nContinuer ?",
      dgEnterLabelForNewRow: "Saisissez l'intitulé de la nouvelle ligne :",
      dgConfirmDeletionthisWillPermanently4: "⚠️ Confirmer la suppression\n\nCe critère d'évaluation sera définitivement supprimé.\nCette action est irréversible.\n\nContinuer ?",
      dgDocumentLibraryIsStillLoading: "La bibliothèque de documents est encore en cours de chargement. Patientez un instant et réessayez.",
      dgPleaseFillInAtLeast: "Veuillez remplir au moins un onglet avant d'exporter !",
      dgExportInProgressProcessingContent: "⏳ Export en cours... Traitement du contenu et des images...",
      dgDocumentExportedSuccessfullyFileMb: "✅ Document exporté avec succès ! Fichier : {v0} ({v1} Mo)",
      dgExportFailed: "❌ Échec de l'export : ",
      dgRemoveThisMarkThisAction: "Supprimer cette marque ?\nCette action est irréversible.",
      dgImportedModulesWithLearningOutcome: "{v0} modules et {v1} résultats d'apprentissage importés depuis DACUM Live Pro !",
      dgSwitchedTo: "Basculé vers {v0}",
      dgSwitchedTo2: "Basculé vers {v0}",
      dgEnterModuleTitle: "Saisissez le titre du module :",
      dgModuleAddedYouCanNow: "Module ajouté ! Vous pouvez maintenant y ajouter des résultats d'apprentissage.",
      dgPleaseSelectAModuleFirst: "Veuillez d'abord sélectionner un module !",
      dgEnterNewModuleTitle: "Saisissez le nouveau titre du module :",
      dgModuleRenamed: "Module renommé !",
      dgModuleDeleted: "Module supprimé !",
      dgPleaseSelectOrCreateA: "Veuillez d'abord sélectionner ou créer un module !",
      dgEnterLearningOutcomeTitle: "Saisissez le titre du résultat d'apprentissage :",
      dgLearningOutcomeAdded: "Résultat d'apprentissage ajouté !",
      dgPleaseSelectALearningOutcome: "Veuillez d'abord sélectionner un résultat d'apprentissage !",
      dgEnterPerformanceCriterion: "Saisissez le critère de performance :",
      dgPerformanceCriterionAdded: "Critère de performance ajouté !",
      dgEditPerformanceCriterion: "Modifier le critère de performance :",
      dgPerformanceCriterionCannotBeEmpty: "Le critère de performance ne peut pas être vide !",
      dgPerformanceCriterionUpdated: "Critère de performance mis à jour !",
      dgConfirmDeletionthisWillPermanently5: "⚠️ Confirmer la suppression\n\nCe critère de performance sera définitivement supprimé.\nCette action est irréversible.\n\nContinuer ?",
      dgPerformanceCriterionDeleted: "Critère de performance supprimé !",
      dgSwitchedToManualAuthoringMode: "Passage en mode de rédaction manuelle ! Créez vos modules et vos résultats d'apprentissage.",
      dgEnterNewTitle: "Saisissez le nouveau titre :",
      dgLearningOutcomeRenamed: "Résultat d'apprentissage renommé !",
      dgLearningOutcomeDeleted: "Résultat d'apprentissage supprimé !",
      dgEnterNewSectionTitle: "Saisissez le nouveau titre de la section :",
      dgClearAllResourceRows: "Vider toutes les lignes de ressources ?",
      dgInfoSheetAdded: "Fiche d'information {v0} ajoutée !",
      dgNoInfoSheetToRemove: "Aucune fiche d'information à supprimer.",
      dgConfirmDeletionthisWillPermanently6: "⚠️ Confirmer la suppression\n\nLa fiche d'information {v0} sera définitivement supprimée.\nCette action est irréversible.\n\nContinuer ?",
      dgInfoSheetRemoved: "Fiche d'information supprimée !",
      dgActivitySheetAdded: "Fiche d'activité {v0} ajoutée !",
      dgNoActivitySheetToRemove: "Aucune fiche d'activité à supprimer.",
      dgConfirmDeletionthisWillPermanently7: "⚠️ Confirmer la suppression\n\nLa fiche d'activité {v0} sera définitivement supprimée.\nCette action est irréversible.\n\nContinuer ?",
      dgActivitySheetRemoved: "Fiche d'activité supprimée !",
      dgConfirmDeletionthisWillPermanently8: "⚠️ Confirmer la suppression\n\nCette étape et ses images seront définitivement supprimées.\nCette action est irréversible.\n\nContinuer ?",
      dgAreYouSureYouWant2: "Voulez-vous vraiment vider cette fiche d'activité ?",
      dgActivitySheetCleared: "Fiche d'activité vidée !",
      dgWorkSavedSuccessfully: "Travail enregistré avec succès ! ✓",
      dgErrorSavingWork: "Erreur lors de l'enregistrement : ",
      dgWorkLoadedSuccessfully: "Travail chargé avec succès !",
      dgWorkLoadedSuccessfullyConvertedFro: "Travail chargé avec succès ! (converti depuis la v2.0)",
      dgOldFormatImportedSuccessfully: "Ancien format importé avec succès !",
      dgErrorLoadingWork: "Erreur lors du chargement : ",
      dgConfirmClearAllDatathisWill: "⚠️ CONFIRMER L'EFFACEMENT DE TOUTES LES DONNÉES\n\nSeront définitivement supprimés :\n• tous les modules et résultats d'apprentissage\n• toutes les fiches d'information et d'activité\n• toutes les pages de couverture et d'introduction\n• tout le contenu d'évaluation\n• toutes les données enregistrées\n\nCette action est IRRÉVERSIBLE.\n\nÊtes-vous absolument sûr de vouloir continuer ?",
      dgAllDataCleared: "Toutes les données ont été effacées !",
      dgPleaseSelectALearningOutcome2: "📚 Veuillez sélectionner un résultat d'apprentissage avant de continuer.\n\nVous pouvez en sélectionner ou en créer un dans l'onglet « Informations de base ».",
      dgWarningDocxLibraryFailedTo: "⚠️ Attention : la bibliothèque DOCX n'a pas pu être chargée. L'export risque de ne pas fonctionner. Vérifiez votre connexion Internet.",
      dgDismiss: "Fermer",
      dgAddRow: "Ajouter une ligne",
      dgAddColumn: "Ajouter une colonne",
      dgDeleteLastRow: "Supprimer la dernière ligne",
      dgDeleteLastColumn: "Supprimer la dernière colonne",
      dgRemoveTable: "Supprimer le tableau",
      dgClearContent: "Effacer le contenu",
      dgRemoveContent: "Supprimer le contenu",
      dgEnterContent: "Saisissez le contenu...",
      dgAddTable: "Ajouter un tableau",
      dgRemoveImage: "Supprimer l'image",
      dgEnterValue: "Saisissez une valeur...",
      dgEnterCriterion: "Saisissez un critère...",
      dgRemoveMark: "Supprimer la marque",
      dgMaterialOrEquipmentName: "Nom du matériel ou de l'équipement...",
      dgRemoveRow: "Supprimer la ligne",
      dgClearStep: "Vider l'étape",
      dgRemoveStep: "Supprimer l'étape",
      dgDescribeThisStep: "Décrivez cette étape...",
      dgNoTeamMembersYet: "Aucun membre d'équipe ajouté pour l'instant. Cliquez sur « Ajouter un membre » pour commencer.",
      tiConvertToNumberedList: "Convertir en liste numérotée",
      tiConvertToBulletedList: "Convertir en liste à puces",
      tiClearFormatting: "Effacer la mise en forme",
      phHttps: "https://...",
      tiNumberedList: "Liste numérotée",
      tiBulletList: "Liste à puces",
      tiRemoveNumberingBullets: "Supprimer la numérotation / les puces",
      tiRenameSectionHeading: "Renommer l'intertitre de la section",
      mbContentLanguage: "Langue du contenu",
      mbQrCode: "QR code",
      mbUnavailable: "Indisponible",
      txModuleBuilderV20: "Module Builder V 2.0",
      txSaveWork: "Enregistrer le travail",
      txLoadWork: "Charger un travail",
      txExportToWord: "Exporter vers Word",
      txClearAll: "Tout effacer",
      txPerformanceCriteriaForThisLearning: "Critères de performance de ce résultat d'apprentissage",
      txUploadAn: "Téléversez une",
      txForBestResults: "pour un résultat optimal.",
      txRecommended: "Recommandé :",
      txAt300DpiOr: "à 300 ppp — ou",
      txAt150Dpi: "à 150 ppp.",
      txSmallerImagesWillBeAutomaticallySt: "Les images plus petites seront automatiquement étirées pour remplir toute la page A4.",
      txNo: "N° :",
      txYes: "Oui",
      txNo2: "Non",
      txCreateYourModuleAddLearningOutcome: "— Créez votre module, ajoutez des résultats d'apprentissage et renseignez les détails du module.",
      txUploadAFrontCoverImageFill: "— Téléversez une image de couverture avant, remplissez le tableau d'informations du module et, si vous le souhaitez, ajoutez une couverture arrière.",
      txAddYourWorkTeamMembersAnd: "— Ajoutez les membres de votre équipe de travail et tout texte introductif.",
      txSelectAModuleAndLearningOutcome: "— Sélectionnez un module et un résultat d'apprentissage, puis ajoutez des fiches d'information avec sections de contenu, objectifs et activités d'auto-évaluation.",
      txSelectAModuleAndLearningOutcome2: "— Sélectionnez un module et un résultat d'apprentissage, puis ajoutez des fiches d'activité avec étapes, ressources et critères.",
      txSelectAModuleAndAddAssessment: "— Sélectionnez un module et ajoutez des formulaires d'évaluation avec critères, vérification et parties signature.",
      txAddYourBibliographyEntriesTheseWil: "— Ajoutez vos entrées bibliographiques. Elles constitueront la dernière page de contenu avant la couverture arrière.",
      txSaveYourProgressToAJson: "— Enregistrez votre progression dans un fichier JSON à tout moment. Utilisez",
      txToRestoreItLater: "pour la restaurer plus tard.",
      txWhenReadyExportTheCompleteModule: "— Lorsque vous êtes prêt, exportez le module complet sous forme de fichier DOCX mis en forme.",
      txQrCode: "QR code",
      txUnavailable: "Indisponible",
      txModuleBuilderIsProvidedAsIs: "Module Builder est fourni « en l'état », sans garantie d'aucune sorte. Le développeur décline toute responsabilité quant aux inexactitudes, erreurs, omissions ou incohérences présentes dans les documents générés. Les utilisateurs et les institutions accompagnatrices sont seuls responsables de la vérification, de la validation et des décisions finales relatives à l'ensemble du contenu avant utilisation.",
      dgAddContent: "Ajouter du contenu",
      dgAddTableBtn: "Ajouter un tableau",
      dgAddRowBtn: "Ajouter une ligne",
      dgDeleteForm: "Supprimer le formulaire",
      dgSignatures: "Signatures",
      dgTrainerSignature: "Signature du formateur",
      dgLearnerSignature: "Signature de l'apprenant",
      dgTrainerDate: "Date (formateur)",
      dgLearnerDate: "Date (apprenant)",
      dgSignaturesManual: "Les signatures seront apposées à la main sur le formulaire imprimé.",
      dgNoCriteriaAvailable: "Aucun critère de performance disponible. Cliquez sur « Ajouter un critère » pour en créer un.",
      expResultPlain: "Résultat",
      cvSector: "Secteur :",
      cvOccupation: "Métier :",
      cvJob: "Poste :",
      cvQualification: "Intitulé de la certification :",
      cvUnitTitle: "Intitulé de l'unité :",
      cvModuleCode: "Code de l'unité :",
      cvLevel: "Niveau :",
      cvVersion: "Version :",
      cvEntryReq: "Conditions d'accès / prérequis :",
      cvQualType: "Type de certification :",
      cvFramework: "Nom du cadre (TVQF/NQF) et version / année :",
      cvFrameworkHint: "ex. TVQF – Irak, lignes directrices 2018",
      cvHours: "Heures d'apprentissage notionnelles :",
      cvAwardingBody: "Organisme certificateur / d'accréditation :",
      cvRpl: "Validation des acquis de l'expérience (VAE) :",
      cvAccredited: "Date d'accréditation :",
      cvReviewDue: "Date de révision prévue :",
      cvAlignment: "Référencement international / régional :",
      cvAlignmentHint: "ex. référencée au niveau 4 du CEC",
      asRestored: "Session précédente restaurée",
      asBackupReminder: "N'oubliez pas d'enregistrer votre travail (sauvegarde)",
      asSaveNow: "Enregistrer maintenant",
      rxClearForm: "Vider le formulaire",
      rxActions: "Actions",
      rxClearRows: "Vider les lignes",
      rxRow: "Ligne",
      rxCol: "Col.",
      rxRemove: "Supprimer",
      rxAddImageS: "Ajouter une ou plusieurs images",
      rxRename: "Renommer",
      dgNoSheets: "Aucune fiche",
      dgDefaultLOName: "Résultat d'apprentissage {v0}",
      dgDefaultModuleName: "Module {v0}",
      dgSheetXOfY: "Fiche {v0} sur {v1}",
      dgAddMark: "Ajouter une marque",
      dgAddImages: "Ajouter une ou plusieurs images",
      dgAddStep: "Ajouter une étape",
      dgContentN: "Contenu {v0} :",
      dgRenameContent: "Renommer cette section de contenu",
      mbNoContentSections: "Aucune section de contenu. Utilisez le bouton ci-dessous pour en ajouter une.",
      mbNoSteps: "Aucune étape. Utilisez le bouton ci-dessous pour en ajouter une.",
      dgEnterContentHeading: "Nom de cette section de contenu (laisser vide pour rétablir le nom par défaut) :",
      dgContentRenamed: "Section de contenu renommée !",
      dgContentHeadingReset: "Nom par défaut rétabli.",
      mbExportLanguage: "Langue d'export",
      expObjective: "Objectif :",
      expDuration: "Durée : ",
      expMaterialEquipment: "Matériel / équipement",
      expQuantityNumber: "Quantité / nombre",
      expActivitySteps: "Étapes de l'activité :",
      expWorkTeam: "Équipe de travail",
      expName: "Nom",
      expTask: "Tâche",
      expWorkLocation: "Lieu de travail",
      expPerformanceCriteria: "Critères de performance :",
      expTrainingResources: "Ressources de formation :",
      expAssessmentUnitCaps: "UNITÉ D'ÉVALUATION",
      expAssessmentUnit: "Unité d'évaluation",
      expPortfolioOfEvidence: "Portfolio de preuves",
      expResult: "Résultat :",
      expWatchVideo: "Regarder une vidéo...",
      expMinutes: "{v0} minutes",
      expDidYou: "Avez-vous...",
      expYes: "Oui",
      expNo: "Non",
      expAssessmentCriteria: "Critères d'évaluation",
      expNameNumberActivities: "Intitulé et numéro des activités d'apprentissage",
      expOutcomesMethod: "Résultats ou méthode d'évaluation",
      expEvidenceVerification: "Vérification des preuves",
      expCompletionDateNotes: "Date de réalisation ou observations",
      expReferences: "Références",
      ...
      expActivitySheetTitled: "Fiche d'activité / de travail {v0} / {v1}",
      expActivitySheetUntitled: "Fiche d'activité / de travail / {v0}",
      expInfoSheetTitled: "Fiche d'information {v0} / {v1}",
      expSelfCheck: "Auto-évaluation / {v0}",
      expAnswersKey: "Corrigé / {v0}",
      expStepN: "Étape {v0} :",
      expCriteriaCheckList: "Liste de vérification des critères de performance / {v0}",
      expLearningOutcomeN: "Résultat d'apprentissage {v0} : {v1}",
      expCompetent: "Compétent",
      expNotYetCompetent: "Pas encore compétent",
      expTrainerName: "Nom du formateur",
      expLearnerName: "Nom de l'apprenant",
      expSignatureLine: "{v0} : {v1}     Signature : {v2}     Date : {v3}",
      expCriteriaInstructionDefault: "Avant de demander au formateur de clôturer l'activité... évaluez-vous en répondant aux questions suivantes :",
      expCriteriaFooterDefault: "La réponse attendue pour tous les items est (oui). Si la réponse est (non), la compétence doit être retravaillée jusqu'à sa maîtrise.",
      mkAttention: "Attention",
      mkReview: "Révision",
      mkQuestion: "Question",
      mkReflect: "Réflexion",
      ...
      mkTip: "Conseil",
      mkImportant: "Important",
      mkRemember: "À retenir",
      mkWarning: "Avertissement",
      mkExample: "Exemple",
      mkGoodPractice: "Bonne pratique",
      dgEnterMarkContent: "Saisissez le contenu « {v0} »...",
      dgCustomFieldDefault: "Champ personnalisé :",
      dgTeamName: "Nom",
      dgTeamTask: "Tâche",
      dgTeamLocation: "Lieu de travail",
      dgConfirmDeletionthisWillPermanently9: "⚠️ Confirmer la suppression\n\nCe membre sera définitivement retiré de la liste.\nCette action est irréversible.\n\nContinuer ?",
      dlgOk: "OK",
      dlgCancel: "Annuler",
      dlgConfirm: "Confirmer",
      dlgDelete: "Supprimer",
      dlgSave: "Enregistrer",
    },
    ...
    ar: {
      ...
      tqCard: "بطاقة إطار المؤهلات (TVQF/NQF)",
      tqExtCard: "حقول موسّعة (اختياري)",
      tqClear: "تفريغ البطاقة",
      tqClearConfirm: "⚠️ تفريغ بطاقة الإطار؟\n\nسيؤدي هذا إلى مسح كل حقول البطاقة بشقّيها، في اللغتين معاً.\nلا يمكن التراجع عن هذا الإجراء.\n\nهل تريد المتابعة؟",
      tqCleared: "تم تفريغ بطاقة الإطار",
      tqBasicNote: "اختيارية. تبيّن موقع هذه الوحدة ضمن إطار وطني للمؤهلات. الحقول التي تُترك فارغة لا تظهر في التصدير.",
      tqExtNote: "لا يظهر في الوثيقة المصدَّرة إلا ما تملؤه فعلاً.",
      tqFromUnitTable: "من جدول معلومات الوحدة",
      tqFramework: "اسم الإطار ونسخته / سنته",
      tqFrameworkHint: "مثال: TVQF - العراق، إرشادات 2018",
      tqHours: "عدد الساعات الاسمية",
      tqAwardingBody: "الجهة المانحة / المعتمِدة",
      tqKnowledge: "المعرفة",
      tqSkill: "المهارة",
      tqCompetence: "الكفاءة",
      tqEntry: "متطلبات القبول المسبقة",
      tqProgression: "مسار التقدّم",
      tqType: "نوع المؤهل",
      tqTypePrincipal: "رئيسي",
      tqTypeComponent: "مكوّن",
      tqTypeAddendum: "ملحق",
      tqMethod: "آلية التقييم المعتمدة",
      tqRpl: "الاعتراف بالتعلّم السابق (RPL)",
      tqYes: "نعم",
      tqNo: "لا",
      tqAccredited: "تاريخ الاعتماد",
      tqReviewDue: "تاريخ المراجعة القادمة",
      tqAlignment: "المواءمة المرجعية الدولية / الإقليمية",
      tqAlignmentHint: "مثال: مُواءَم مع المستوى 4 في EQF",
      tqCardHeading: "إطار المؤهلات",
      tqExtHeading: "إطار المؤهلات - تفاصيل إضافية",
      mbCovers: "الأغلفة",
      ...
      mbRename: "إعادة تسمية",
      mbDelete: "حذف",
      mbUntitled: "بلا عنوان",
      mbLearningOutcomes: "📚 محصلات التعلم:",
      mbTotalSheets: "📄 مجموع الأوراق:",
      mbTaskAnalysisReference: "📥 مرجع تحليل المهمة (من DACUM Live Pro)",
      mbTaskAnalysisReferenceIntro: "تفاصيل مصدرية لمهمة (مهام) هذه الوحدة — للاطلاع فقط. لا يُنسخ شيء تلقائياً؛ استعن بها أثناء كتابة ورقة المعلومات وورقة النشاط/العمل ووحدة التقييم أدناه.",
      mbTaReqKnowledge: "📘 المعارف المطلوبة",
      mbTaReqSkills: "🧩 المهارات المطلوبة",
      mbTaPerfSteps: "🛠️ خطوات الأداء",
      mbTaTools: "🧰 الأدوات والمعدات والمواد",
      mbTaSafety: "⚠️ السلامة والصحة المهنية",
      mbTaConditions: "🏗️ ظروف / بيئة العمل",
      mbTaDecisions: "🧭 القرارات / النقاط الحرجة",
      mbTaStandard: "🎯 مستوى الأداء المعياري",
      mbTaErrors: "🐛 الأخطاء الشائعة / استكشاف الأعطال",
      mbTrainingStructureMapping: "هيكلة البنية التدريبية",
      mbMappingIntro: "اقترح أوراق معلومات وأوراق نشاط/عمل ومحتوى تقييم انطلاقاً من نتائج التعلم ومعايير الأداء وتحليل المهام لهذه الوحدة — ثم راجع وعدّل ووافق قبل إنشاء أي شيء. لا يُكتب شيء تلقائياً.",
      mbAiAssistedMapping: "🤖 هيكلة بمساعدة الذكاء الاصطناعي",
      mbManualMapping: "✍️ هيكلة يدوية",
      mbAiModeExplain: "يحلل الذكاء الاصطناعي بيانات هذه الوحدة فقط (نتائج التعلم، معايير الأداء، المهام المصدر، وحقول تحليل المهام المُدخلة فعلياً) ويقترح بنية. لا يخترع أبداً معلومات مهنية غير موجودة.",
      mbAnalyzeAndSuggest: "تحليل واقتراح البنية",
      mbNoModuleSelected: "يرجى اختيار وحدة أولاً.",
      mbNoLOsToAnalyze: "لا توجد نتائج تعلم في هذه الوحدة لتحليلها بعد.",
      mbAnalyzing: "جارٍ التحليل…",
      mbAiRateLimited: "خدمة الذكاء الاصطناعي مشغولة حالياً — يرجى المحاولة بعد قليل.",
      mbAiServerError: "خدمة الذكاء الاصطناعي غير متاحة مؤقتاً. يرجى المحاولة قريباً.",
      mbAiRequestFailed: "تعذّر إتمام الطلب. يرجى المحاولة مرة أخرى.",
      mbAiInvalidResponse: "أعاد الذكاء الاصطناعي استجابة غير متوقعة. يرجى المحاولة مرة أخرى.",
      mbAiProposalReady: "البنية المقترحة جاهزة للمراجعة.",
      mbAiTimeout: "استغرق الطلب وقتاً طويلاً وتم إلغاؤه. يرجى المحاولة مرة أخرى.",
      mbAiNetworkError: "تعذّر الوصول إلى خدمة الذكاء الاصطناعي — تحقق من الاتصال وحاول مرة أخرى.",
      mbSources: "المصادر",
      mbNoItemsYet: "لا يوجد شيء هنا بعد.",
      mbProposalInfoSheets: "أوراق المعلومات",
      mbAddInfoSheetSuggestion: "إضافة ورقة معلومات",
      mbActivityJobSheets: "أوراق النشاط / العمل",
      mbAddActivitySheetSuggestion: "إضافة ورقة نشاط/عمل",
      mbAssessmentUnitsTitle: "التقييم",
      mbAddAssessmentSuggestion: "إضافة اقتراح تقييم",
      mbMissingInfoTitle: "معلومات ناقصة",
      mbApproveAndBuild: "الموافقة وإنشاء الوحدة",
      mbEnterTitle: "أدخل العنوان:",
      mbNothingToApprove: "لا يوجد شيء للموافقة عليه بعد.",
      mbConfirmApprove: "هل تريد إنشاء {v0} عنصر كأوراق حقيقية الآن؟ يمكنك متابعة تعديلها لاحقاً.",
      mbModuleBuilt: "تمت إضافة العناصر المعتمدة إلى هذه الوحدة.",
      mbNotLinkedYet: "لم يُربط بأي مصدر بعد — اضغط أيقونة التعديل لربطه.",
      mbEditLinks: "تعديل العنوان والروابط",
      mbLinkLearningOutcomes: "الربط بنتيجة (نتائج) تعلم",
      mbLinkPerformanceCriteria: "الربط بمعايير أداء",
      mbLinkSourceTasks: "الربط بمهمة (مهام) مصدر",
      mbLinkTaFields: "الربط بحقل (حقول) تحليل المهمة",
      mbLinkTaItems: "اختيار عناصر فردية من تحليل المهمة",
      mbSourceBrowserTitle: "تصفّح تحليل المهمة — اختر عناصر ثم أنشئ ورقة",
      mbSourceBrowserIntro: "ضع علامة على عناصر فردية أدناه، ثم اختر نوع الورقة المطلوب إنشاؤها منها. لا يُنشأ شيء قبل الضغط على أحد الأزرار.",
      mbCreateInfoFromSelection: "إنشاء ورقة معلومات",
      mbCreateActivityFromSelection: "إنشاء ورقة نشاط/عمل",
      mbCreateAssessmentFromSelection: "إنشاء تقييم",
      mbSelectAtLeastOneItem: "اختر عنصراً واحداً على الأقل.",
      mbItemCreatedFromSelection: "أُضيف إلى الاقتراح أدناه — يمكنك تعديل عنوانه أو روابطه في أي وقت.",
      mbSomeAssessmentsSkipped: "تم تجاوز {v0} اقتراح تقييم — اربطها أولاً بنتيجة تعلم (أيقونة التعديل)، ثم وافق مرة أخرى.",
      mbAllItemsAssigned: "جميع عناصر تحليل المهمة لهذه الوحدة مُخصّصة بالفعل — ألغِ تخصيص أحدها أدناه لإعادته متاحاً.",
      mbNoneYet: "لا يوجد بعد",
      mbInheritedLinksTitle: "موروث من تحليل المهمة (تلقائي — غير قابل للتعديل هنا)",
      mbAssignedItemsTitle: "العناصر المخصَّصة / المستخدَمة",
      mbAssignedItemsIntro: "أين يقع كل عنصر مختار حالياً. انقله إلى ورقة أخرى، أو ألغِ تخصيصه لإعادته إلى قائمة التصفح أعلاه.",
      mbMoveTo: "نقل إلى…",
      mbUnassign: "إلغاء التخصيص — إعادة إلى المتاح",
      mbItemMovedTo: "نُقل إلى \"{v0}\".",
      ...
      mbRemoveFrontCoverImage: "إزالة صورة الغلاف الأمامي",
      ...
      mbFillInTheModuleDetailsBelow: "املأ تفاصيل الوحدة أدناه. عناوين الحقول قابلة للتحرير مباشرةً — انقر على العنوان واكتب. الحقول الفارغة لا تُصدَّر.",
      cvLabelEditHint: "انقر لتحرير هذا العنوان",
      mbInfoObjectiveLead: "بعد دراستك ورقة المعلومات ستصبح قادرًا على:",
      mbActivityObjectiveLead: "بعد إكمالك لهذا النشاط ستصبح قادراً على:",
      ...
      mbRemoveBackCoverImage: "إزالة صورة الغلاف الخلفي",
      ...
      mbEnterSelfCheckQuestionsAndContent: "أدخل أسئلة التقييم الذاتي ومحتواه…",
      mbAnswersKey: "الأجوبة النموذجية:",
      mbEnterAnswersKeyContent: "أدخل محتوى الأجوبة النموذجية…",
      ...
      txSelectAModuleAndLearningOutcome: "— اختر وحدة ومحصلة تعلم، ثم أضف أوراق معلومات بمحتواها وصورها والتقييم الذاتي.",
      ...
      cvOccupation: "المهنة:",
      cvJob: "العمل:",
      cvQualification: "اسم المؤهل:",
      cvUnitTitle: "اسم الوحدة:",
      cvModuleCode: "رمز الوحدة:",
      cvLevel: "المستوى:",
      cvVersion: "الإصدار:",
      cvEntryReq: "متطلبات القبول المسبقة:",
      cvQualType: "نوع المؤهل:",
      cvFramework: "اسم الإطار (TVQF/NQF) ونسخته / سنته:",
      cvFrameworkHint: "مثال: TVQF - العراق، إرشادات 2018",
      cvHours: "عدد الساعات الاسمية:",
      cvAwardingBody: "الجهة المانحة / المعتمِدة:",
      cvRpl: "الاعتراف بالتعلّم السابق (RPL):",
      cvAccredited: "تاريخ الاعتماد:",
      cvReviewDue: "تاريخ المراجعة القادمة:",
      cvAlignment: "المواءمة المرجعية الدولية / الإقليمية:",
      cvAlignmentHint: "مثال: مُواءَم مع المستوى 4 في EQF",
      ...
      dgRenameContent: "إعادة تسمية قسم المحتوى هذا",
      mbNoContentSections: "لا توجد بطاقات محتوى. استخدم الزر أدناه لإضافة بطاقة.",
      mbNoSteps: "لا توجد خطوات. استخدم الزر أدناه لإضافة خطوة.",
      dgEnterContentHeading: "اسم قسم المحتوى (اتركه فارغاً لاستعادة الاسم الافتراضي):",
      dgContentRenamed: "أُعيدت تسمية قسم المحتوى!",
      dgContentHeadingReset: "تمت استعادة الاسم الافتراضي.",
      ...
      lgEnabled: "سيُضمَّن دليل التعلم",
      lgDisabled: "لن يُضمَّن دليل التعلم",
      ...
      expSelfCheck: "التقييم الذاتي / {v0}",
      expAnswersKey: "الأجوبة النموذجية / {v0}",
      expStepN: "الخطوة {v0}:",
