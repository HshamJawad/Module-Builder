...
(function () {
  ...
  var TRANSLATIONS = {
    ...
    en: {
      ...
      dgImportLangSwitch: "This project was authored in {v0}, but the editor is currently set to {v1}. The language will be switched to {v0} so the content is visible — otherwise every field would appear empty. You can change the interface language again afterwards.",
    ...
    fr: {
      ...
      mbFillInTheModuleDetailsBelow: "Renseignez les détails du module ci-dessous. Cliquez sur « Renommer » pour personnaliser les intitulés des champs. Les champs laissés vides ne sont pas exportés.",
      ...
      dgImportLangSwitch: "Ce projet a été rédigé en {v0}, alors que l'éditeur est actuellement en {v1}. La langue va passer en {v0} afin que le contenu soit visible — sinon tous les champs apparaîtraient vides. Vous pourrez rechanger la langue de l'interface ensuite.",
    ...
    ar: {
      ...
      dgImportLangSwitch: "هذا المشروع مُؤلَّف بـ{v0}، بينما المحرِّر مضبوط حالياً على {v1}. ستُبدَّل اللغة إلى {v0} ليظهر المحتوى — وإلا ستبدو جميع الحقول فارغة. يمكنك تغيير لغة الواجهة مرة أخرى بعد ذلك.",
