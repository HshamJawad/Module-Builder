...
(function () {
  ...
  var TRANSLATIONS = {
    ...
    en: {
      ...
      tqBasicCard: "TVQF/NQF Basic Card",
      tqExtCard: "TVQF/NQF Extended Fields (Optional)",
    ...
    fr: {
      tqBasicCard: "Carte de base CNC/TVQF",
      tqExtCard: "Champs etendus CNC/TVQF (facultatif)",
    ...
    ar: {
      ...
      tqBasicCard: "بطاقة إطار المؤهلات الأساسية (TVQF/NQF)",
      tqExtCard: "حقول إطار المؤهلات الموسّعة (اختياري)",
